...
void updateDisplay() {
  ...
  switch (current) {
    ...
    case BRAZO_ACTIVO:    display.print("BRAZO"); break;
    case CLASIFICANDO:    display.print("CLAS");  break;
    case BANDA_CORRIENDO: display.print("BANDA"); break;
    default: break;
  }
...
void setup() {
  ...
  // Dar tiempo al Slave para terminar su setup
  delay(2000);
